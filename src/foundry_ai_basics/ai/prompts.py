...
def truncate_system_instruction(
    instruction: str,
    model: str | None = None,
    max_tokens: int = 4000,
) -> tuple[str, int]:
    token_count = count_tokens(instruction, model=model)
    ...
    new_token_count = count_tokens(truncated, model=model)
